    ...
    return (
        <Link href={`projects/${href}`} className="hover:scale-[0.99] transition-all ease duration-500">
            ...
            >
                ...
                <div
                    ref={ref}
                    className={`rounded-2xl bg-gradient-to-t overflow-hidden from-[#101010] border border-zinc-700/80 relative ${bgColor == "#194A69" ? " to-[#194A69] " : "to-[#3D2B74] "}`}
                >
                    <div className="absolute top-0 w-[100%] left-1/2 -translate-x-1/2 h-[1px] bg-gradient-to-r from-zinc-900 via-zinc-500 to-zinc-900" />
                    ...
                    <div className="p-6 relative flex justify-between items-start">
                        ...
                        <div>
                            <IoMdArrowForward className="text-4xl icon transition-all ease-out duration-500 hover:-rotate-45 md:mr-[0.1vmax] text-zinc-300" />
                        </div>
                    </div>
